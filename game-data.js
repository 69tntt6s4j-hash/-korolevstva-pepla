/* 8.7.0-full-fix: immutable game definitions; original army/economy values. */
(function(root,factory){
  ...
  ;
  const VERSION='8.7.0-full-fix', SCHEMA=1, W=26,H=20,WORLD_W=2600,WORLD_H=2000;
  const skills={
    logistics:{
  ...
  const bridges=[[11,5],[7,7],[16,8],[16,10],[19,12],[3,15],[4,15],[5,15]];
