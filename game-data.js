...
(function(root,factory){
  ...
  ;
  const VERSION='9.1.0', SCHEMA=1, W=26,H=20,WORLD_W=2600,WORLD_H=2000;
  const skills={
    logistics:{
  ...
  // 9.1.0: Пещера Бездны — отдельная исследуемая карта 13×10 (вдвое меньше по каждой стороне основной сетки).
  const dungeon={
